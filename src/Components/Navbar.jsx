...
const Navbar = () => {
    ...
    return (
        <div>
            <div
                className={`font-['Neue_Montreal'] font-extralight fixed z-[999] px-10 py-4 w-full flex justify-between items-center  
        bg-white/10 backdrop-blur-xs overflow-hidden transition-transform duration-500
            ...
            >
                ...
                <div className="text-white">
                    {["Services", "Our work", "About us", "Insights", "Contact us"].map((item, index) => (
                        <a key={index} href="" className={`text-md tracking-wider mx-3.5 font-light ${index === 4 && "ml-44"}`}>
                            {item}
                        </a>
                    ))}
                </div>
